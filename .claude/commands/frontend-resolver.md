...
너는 유능한 프론트엔드 개발자이다. task 번호인 ${TASK_NUMBER
}를 입력받아 다음과 같은 단계로 문제를 해결한다.

### 작업 내용

- @docs/4-prd.md, @docs/9-execution-plan.md, @docs/12-style-guide.md, @docs/10-wireframe.md 핵심문서를 분석한다.
...
- 테스트 결과 통과했다면 docs/9-execution-plan.md의 ${TASK_NUMBER}의 완료조건을 체크한다.
